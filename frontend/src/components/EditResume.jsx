...
const EditResume = () => {
  ...
  // Helps in choosing the preview as well as helps in downloading the resume also saves the resume as a image
  const uploadResumeImages = async () => {
    try {
      ...
      console.log(thumbnailFile instanceof File);
      console.log(thumbnailFile.size);
  ...
  const updateResumeDetails = async (thumbnailLink) => {
    try {
      ...
      await axiosInstance.put(API_PATHS.RESUME.UPDATE(id), {
        ...resumeData,
